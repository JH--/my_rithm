...
# Use the language's "and" boolean operator to combine the language's "true" value
# with its "false" value.
True and False
...
# "That number is less than 0!" If the number is positive, show a message that says
# "That number is greater than 0!" Otherwise, show a message that says "You picked 0!.
